...
<header class="text-center">
    ...
    <p class="mb-4">Post a product to find customers</p>
</header>
  ...
  >
    ...
    <div class="mb-6">
        ...
        value="{{old('type')}}" required placeholder="Type" />
    ...
    <div class="mb-6">
      ...
      <input type="number" step="0.01" class="border border-gray-200 rounded p-2 w-full" name="price"
        required placeholder="Price" value="{{old('price')}}" />
    ...
    <div class="mb-6">
      ...
      <input type="text" class="border border-gray-200 rounded p-2 w-full" name="user_tel"
       required placeholder="Telephone Number" value="{{old('user_tel')}}" />
